...
class ImportViewModel(QObject):
    ...
    def executeImport(self) -> None:
        ...
        thread = _ImportThread(self._importer, self._job_fetcher, list(self._pending_files))
...
class _ImportThread(QThread):
    ...
    def __init__(self, importer: Callable, job_fetcher: Callable, paths: list[str], parent=None):
        super().__init__(parent)
        self._importer = importer
        self._job_fetcher = job_fetcher
        self._paths = paths
